...
Route::get('add_categories',[categories::class,'add_categories'])->name('add_categories');
Route::get('edit_categories',[categories::class,'edit_categories'])->name('edit_categories');